					...
					<div class="control-group">
						...
						{forminput}
							...
							{if $gContent->mInfo.source_file}
								<input type="submit" class="btn btn-default" name="reprocess_upload" value="{tr}Re-process uploaded File{/tr}" />
					...
					<div class="control-group">
						...
						{forminput}
							...
							{if !$gContent->mInfo.thumbnail_is_mime}
								<input type="submit" class="btn btn-default" name="delete_thumbnails" value="{tr}Delete Thumbnail{/tr}" />
