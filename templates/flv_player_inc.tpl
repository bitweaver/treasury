...
<script type="text/javascript">/* <![CDATA[ */
	...
	flashvars:"file={$flv.flv_url}&showdigits={$flvPrefs.digits|default:'true'}&autostart=false&image={$flv.thumbnail_url.medium}&showfsbutton=true&repeat=false" {rdelim};
