...
<div class="row">
	<object type="application/x-shockwave-flash" data="{$smarty.const.TREASURY_PKG_URL}templates/flash.container.swf?path={$gContent->mInfo.source_url}" width="100%" height="480">
