<?php
/**
 * @version      $Header: /cvsroot/bitweaver/_bit_treasury/upload.php,v 1.26 2008/06/25 22:21:27 spiderr Exp $
 *
...
$gBitSystem->display( 'bitpackage:treasury/upload.tpl', tra( 'Upload File' ) , array( 'display_mode' => 'display' ));
?>
